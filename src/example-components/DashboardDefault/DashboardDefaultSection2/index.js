...
import { IconButton, LinearProgress, Card, CardContent, Button, Tooltip } from '@material-ui/core'
    ...
    <Fragment>
      <Card className='card-box mb-4'>
        ...
        <div className='card-footer d-flex justify-content-between'>
          ...
          <div>
            <Button size='small' variant='contained' className='mr-3' color='primary'>
              View all
            </Button>
