...
import { Grid, IconButton, LinearProgress, Card, CardContent, Button, List, ListItem, Tooltip, Divider } from '@material-ui/core'
        ...
        <div className='d-flex flex-row flex-wrap justify-content-center'>
          <div className='position-relative px-5 py-3'>
            ...
            <div className='font-weight-bold font-size-sm text-black-50'>
              <FontAwesomeIcon icon={['fas', 'star']} className='text-warning mr-1' />
              <span>4.8</span>
      ...
      <Grid container spacing={4}>
        <Grid item xs={12} lg={7}>
          <Card className='card-box mb-4'>
            <div className='card-header'>
              <div className='font-size-lg d-block text-truncate'>
                <span className='text-black-50 pr-2'>#32</span> Global competition
              </div>
          ...
          <Card className='card-box mb-4'>
            <div className='card-header'>
              <div className='font-size-lg d-block text-truncate'>
                <span className='text-black-50 pr-2'>#33</span> International Event
              </div>
              <div className='ml-auto d-flex align-items-center align-content-center'>
                <Tooltip arrow title='View all participants'>
                  <IconButton color='primary' className='ml-3'>
            ...
            <List>
              <ListItem className='d-block p-0'>
                ...
                <div className='card-header rounded-0 bg-light'>
                  ...
                  <div className='ml-auto d-flex align-items-center align-content-center'>
                    <Tooltip arrow title='View all participants'>
                      <Button color='primary' className='font-size-lg ml-3 d-40 p-0 rounded-circle border-0'>
                        <AddCircleTwoToneIcon />
                      </Button>
                    </Tooltip>
                  </div>
          ...
          <Card className='card-box mb-4'>
            <div className='px-4 px-xl-5 pb-1'>
              <div className='card-header d-block'>
                <span className='text-uppercase py-3 py-xl-4 text-black d-block text-center font-weight-bold font-size-lg'>Inventory</span>
              </div>
                ...
                <div className='grid-menu grid-menu-2col'>
                  <Grid container spacing={4}>
                    <Grid item xs={12} sm={6}>
                      <div className='text-center'>
                        <FontAwesomeIcon icon={['fas', 'lemon']} className='font-size-xxl text-warning my-3' />
                        <span className='text-black-50 d-block'>Users</span>
                        <b className='font-size-xxl'>2,345</b>
                      </div>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <div className='text-center'>
                        <FontAwesomeIcon icon={['far', 'user']} className='font-size-xxl text-success my-3' />
                        <span className='text-black-50 d-block'>Revenue</span>
                        <b className='font-size-xxl'>$9,693</b>
                      </div>
                    </Grid>
              ...
              <div className='card-header border-0 d-block'>
                <span className='text-uppercase pt-4 pb-2 text-black d-block text-center font-weight-bold font-size-lg'>Activity</span>
              </div>
              <div className='py-2'>
              ...
              <div className='card-header border-0 d-block'>
                <span className='text-uppercase pb-1 pt-1 text-black d-block text-center font-weight-bold font-size-lg'>Charts</span>
              </div>
              <Chart options={chart53Options} series={chart53Data} type='area' height={155} />
            </div>
