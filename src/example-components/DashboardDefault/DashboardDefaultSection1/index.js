            ...
            <CardContent className='p-3'>
              <div className='d-flex align-items-start'>
                <div className='font-weight-bold'>
                  <small className='text-white-50 d-block mb-1 text-uppercase'>New Accounts</small>
              ...
              <div className='mt-3'>
                <FontAwesomeIcon icon={['fas', 'arrow-up']} className='text-success mr-1' />
        ...
        <Grid item xs={12} sm={6} md={4}>
          <Card className='card-box bg-midnight-bloom text-light mb-4'>
            <CardContent className='p-3'>
              <div className='d-flex align-items-start'>
                <div className='font-weight-bold'>
                  <small className='text-white-50 d-block mb-1 text-uppercase'>Sales</small>
              ...
              <div className='mt-3'>
                <FontAwesomeIcon icon={['fas', 'arrow-up']} className='text-warning mr-1' />
        ...
        <Grid item xs={12} md={4}>
          <Card className='card-box bg-plum-plate text-light mb-4'>
            <CardContent className='p-3'>
              ...
              <div className='mt-3'>
                <FontAwesomeIcon icon={['fas', 'arrow-down']} className='text-white mr-1' />
          ...
          <Card className='card-box mb-4'>
            <CardContent className='p-0'>
              <Grid container spacing={4} className='mt-4'>
                ...
                <Grid item xs={12} sm={4}>
                  <div className='text-center'>
                    <div>
                      <FontAwesomeIcon icon={['far', 'keyboard']} className='font-size-xxl text-danger' />
                    </div>
                    <div className='mt-3 line-height-sm'>
            ...
            <div className='card-footer bg-light text-center'>
              <div className='pt-4 pr-4 pl-4'>
                <Chart options={chart30Options} series={chart30Data} type='line' height={100} />
              </div>
            </div>
          </Card>
        </Grid>
        <Grid item xs={12} lg={6}>
          <Card className='card-box mb-4'>
            <div className='card-body pb-1'>
              ...
              <div className='pt-4 pr-4 pl-4'>
                <Chart options={chart31Options} series={chart31Data} type='line' height={100} />
              </div>
            </div>
            <Divider />
            <div className='my-2 text-center'>
              <FontAwesomeIcon icon={['fas', 'arrow-up']} className='text-danger' />
