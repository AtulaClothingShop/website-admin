...
import { Grid, Badge, Card, Button, List, ListItem, Divider } from '@material-ui/core'
        ...
        <Grid item xs={12} lg={6}>
          <Card className='card-box mb-4'>
            <List className='py-0'>
              ...
              <Divider />
              <ListItem button className='d-flex justify-content-between align-items-center'>
            ...
            <List className='py-0'>
              <ListItem className='d-flex justify-content-between align-items-center'>
                ...
                <div className='flex-grow-1 pl-2'>
                  ...
                  <p className='card-text mb-0'>This is a short bio for John's widget...</p>
                </div>
                <span className='pl-3'>
                  <Button size='small' color='secondary' className='pl-2 pr-2'>
                    <span className='btn-wrapper--icon'>
                      <FontAwesomeIcon icon={['fas', 'cog']} className='font-size-lg' />
                    </span>
                  </Button>
                </span>
              </ListItem>
