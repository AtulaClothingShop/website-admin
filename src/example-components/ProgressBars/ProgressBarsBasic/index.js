...
export default function LivePreviewExample() {
  ...
  return (
    <Fragment>
      ...
      <LinearProgress variant='determinate' color='secondary' value={45} className='mb-4' />
      <div className='divider mb-4' />
      <LinearProgress variant='buffer' value={completed} valueBuffer={buffer} className='mb-3' />
      <LinearProgress variant='buffer' value={completed} valueBuffer={buffer} className='mb-4' color='secondary' />
      <div className='divider mb-4' />
