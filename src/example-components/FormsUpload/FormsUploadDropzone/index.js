      ...
      <Fragment>
        ...
        <Grid container spacing={4} className='mt-4'>
          ...
          <Grid item md={6} className='d-flex justify-content-center align-items-center'>
            <div className='w-100'>
              {this.state.files.length === 0 && <MuiAlert severity='success'>Files uploaded for demo purposes will appear here!</MuiAlert>}
              {this.state.files.length > 0 && (
                <List>
                  <ListItem className='font-weight-bold text-center'>Uploaded Files</ListItem>
                  {files}
                </List>
              )}
            </div>
