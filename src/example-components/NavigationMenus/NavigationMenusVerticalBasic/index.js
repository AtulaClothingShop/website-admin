...
import { Grid, Typography, Card, List, ListItem, Divider } from '@material-ui/core'
        ...
        <Grid item xs={12} md={6} lg={4}>
          ...
          <Card className='card-box rounded-0 border-2 mb-3'>
            <List className='p-3'>
              ...
              <Typography className='text-black py-2 px-3 font-weight-bold' variant='body2' component='div'>
                Heading
              </Typography>
              <ListItem button className='rounded-sm'>
                <div className='nav-link-icon opacity-6'>
