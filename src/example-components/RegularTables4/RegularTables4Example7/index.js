...
import { Avatar, IconButton, Box, Checkbox, Card, CardContent, Button } from '@material-ui/core'
  ...
  return (
    <Fragment>
      <Card className='card-box mb-4'>
        <div className='card-header'>
          ...
          <Box className='card-header--actions'>
            <IconButton size='small' color='primary' className='text-primary' title='View details'>
              <FontAwesomeIcon icon={['far', 'keyboard']} className='font-size-lg' />
            </IconButton>
          </Box>
        </div>
            ...
            <table className='table table-striped table-hover text-nowrap mb-0'>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className='text-center'>
                    <div className='badge badge-success h-auto py-0 px-3'>Completed</div>
                  </td>
                  <td className='text-center'>
                    <Box>
                      <IconButton color='primary' size='small'>
                ...
                <tr>
                  ...
                  <td className='text-center'>
                    <div className='h-auto py-0 px-3 badge badge-danger'>Declined</div>
                  </td>
                  <td className='text-center'>
                    <Box>
                      <IconButton color='primary' size='small'>
      ...
      <Card className='card-box mb-4'>
        <div className='card-header'>
          <div className='card-header--title'>
            <h4 className='font-size-lg mb-0 py-2 font-weight-bold'>Users list</h4>
          </div>
        </div>
          ...
          <table className='table table-hover table-borderless table-alternate text-nowrap mb-0'>
            ...
            <tbody>
              <tr>
                <td>
                  <div className='d-flex'>
                    ...
                    <div>
                      ...
                      <span className='text-black-50 d-block'>Senior Web Developer</span>
                    </div>
                  </div>
                </td>
                <td className='text-center'>
                ...
                <td className='text-right'>
                  <div className='d-flex align-items-center justify-content-end'>
                    <div className='font-weight-bold font-size-lg pr-2'>2363</div>
                    <FontAwesomeIcon icon={['fas', 'arrow-down']} className='font-size-sm opacity-5' />
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td className='text-right'>
                  <div className='d-flex align-items-center justify-content-end'>
                    <div className='font-weight-bold font-size-lg pr-2'>584</div>
                    <FontAwesomeIcon icon={['fas', 'arrow-down']} className='font-size-sm opacity-5' />
                  </div>
                </td>
              </tr>
              <tr>
                <td>
                  <div className='d-flex'>
                    ...
                    <div>
                      ...
                      <span className='text-black-50 d-block'>User Experience Designer</span>
                    </div>
                  </div>
                </td>
                <td className='text-center'>
                ...
                <td className='text-right'>
                  <div className='d-flex align-items-center justify-content-end'>
                    <div className='font-weight-bold font-size-lg pr-2'>483</div>
                    <FontAwesomeIcon icon={['fas', 'arrow-up']} className='font-size-sm opacity-5' />
                  </div>
                </td>
              </tr>
              <tr>
                <td>
                  <div className='d-flex'>
                    ...
                    <div>
                      ...
                      <span className='text-black-50 d-block'>Senior Consultant</span>
                    </div>
                  </div>
                </td>
                <td className='text-center'>
                ...
                <td className='text-right'>
                  <div className='d-flex align-items-center justify-content-end'>
                    <div className='font-weight-bold font-size-lg pr-2'> $12,23M</div>
                    <FontAwesomeIcon icon={['fas', 'arrow-up']} className='font-size-sm opacity-5' />
                  </div>
                </td>
              </tr>
