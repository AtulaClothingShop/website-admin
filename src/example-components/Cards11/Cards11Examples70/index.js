...
import { Grid, LinearProgress, Card, Button, List, ListItem } from '@material-ui/core'
          ...
          <Card className='card-box mb-4'>
            <div className='card-header'>
              <div className='card-header--title'>
                <b>Monthly targets</b>
                <div className='d-block text-capitalize mt-1 font-size-sm'>Card with progress bars list items.</div>
              </div>
            </div>
            <List>
              <ListItem className='py-2 d-block'>
                <div className='align-box-row mb-1'>
                  ...
                  <div className='ml-auto'>
                    <div className='font-size-xl font-weight-bold text-success'>348</div>
                  </div>
                </div>
                <LinearProgress className='progress-animated-alt' color='secondary' value={34} />
              ...
              <ListItem className='py-2 d-block'>
                ...
                <LinearProgress variant='determinate' color='primary' value={39} />
                <div className='align-box-row progress-bar--label mt-1 text-muted'>
                  <small className='text-dark'>0</small>
                  <div className='ml-auto'>100%</div>
                </div>
              ...
              <ListItem className='py-2 d-block'>
                ...
                <LinearProgress className='progress-animated-alt' color='primary' value={51} />
                <div className='align-box-row progress-bar--label mt-1 text-muted'>
                  <small className='text-dark'>0</small>
                  <div className='ml-auto'>100%</div>
                </div>
          ...
          <Card className='card-box mb-4'>
            ...
            <List>
              <ListItem className='d-block'>
                <div className='align-box-row'>
                  <div className='flex-grow-1'>
                    <LinearProgress color='secondary' variant='determinate' value={61} />
                  </div>
                  <div className='line-height-sm text-center ml-4'>
                    <small className='text-black-50 d-block text-uppercase'>Totals</small>
              ...
              <ListItem className='d-block'>
                <div className='align-box-row'>
                  <div className='flex-grow-1'>
                    <LinearProgress variant='determinate' color='primary' value={44} />
                  </div>
                  <div className='line-height-sm text-center ml-4'>
                    <small className='text-black-50 d-block text-uppercase'>Totals</small>
