...
import { Hidden, IconButton, AppBar, Box, Button, Tooltip } from '@material-ui/core'
    ...
    <Fragment>
      ...
      >
        ...
        <Box className='app-header-toolbar'>
          <Hidden lgUp>
            <Box className='app-logo-wrapper' title='Carolina React Admin Dashboard with Material-UI Free'>
              <Link to='/DashboardDefault' className='app-logo-link'>
                <IconButton color='primary' size='medium' className='app-logo-btn'>
                  <img className='app-logo-img' alt='Carolina React Admin Dashboard with Material-UI Free' src={projectLogo} />
                </IconButton>
              </Link>
              <Hidden smDown>
                <Box className='app-logo-text'>Clothing Shop</Box>
              </Hidden>
            </Box>
          </Hidden>
          ...
          <Box className='d-flex align-items-center'>
            {checkLogin() ? (
              ...
              <Box className='d-flex align-items-center'>
                <Button className='m-1' variant='contained' color='default' size='small' onClick={() => connectWallet()}>
                  Connect Wallet
                </Button>
              </Box>
            )}
