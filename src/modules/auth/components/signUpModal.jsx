...
function SignUpModal(props) {
  ...
  const handleLoginGoogle = () => {
    window.open(
      ...
      '',
      `height=500,width=500,top=${window.innerHeight / 2}, left=${window.innerWidth / 2}`
    )
  }
  ...
  return (
    <Dialog open={openLoginModal} onClose={() => props.handleCloseLoginModal()} fullWidth maxWidth='xs' aria-labelledby='form-dialog-title'>
      <DialogContent>
        <div>
          <div className='bg-secondary border-0'>
            ...
            <div className='card-body px-lg-5 py-lg-5'>
              ...
              <div className='w-100'>
                <FormControlLabel
                  control={
                    <Checkbox checked={rememberMeChecked} onChange={() => handleRememberMe()} value='rememberMeChecked' color='primary' />
                  }
                  label='Remember me'
                />
              </div>
              <div className='text-center'>
                <Button color='primary' variant='contained' onClick={() => handleLogin()} className='mt-4'>
                  Sign in
                </Button>
              </div>
            </div>
